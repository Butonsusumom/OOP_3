    ...
    public String write() throws IOException {
        ...
        String result=
                String.valueOf(super.getId())+
                        ...
                        String.valueOf(dezSkills)+
                        COMMA_DELIMITER+
                        String.valueOf(dezType);
        return result;
    }


    public static Designer read(String[] tokens) throws IOException{
        Designer pers = new Designer(Integer.parseInt(tokens[0]),
                ...
                tokens[15],
                Designer.DezSkills.valueOf(tokens[16]),
                Designer.DezType.valueOf(tokens[17]));
        return pers;
    }
}
